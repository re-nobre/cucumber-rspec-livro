...
Funcionalidade: Adivinhar letra
  Após a palavra do jogo ser sorteada, o jogador pode começar a tetar adivinhar as letras da palavra.
  Cada vez que ele acerta uma letra, o jogo mostra para ele em que posição dentro da palavra está a letra que ele acertou.
  Cada vez que o jogador erra uma letra, uma parte do boneco da forca aparece na forca.
  O jogador pode errar no máximo seis vezes, que correspondem às seis partes do boneco: cabeça, corpo, braço esquerdo, braço direito, perna esquerda, perna direita.
  ...
  * o jogo tem as possíveis palavras para sortear:
  ...
  Se o jogador adivinhar a letra com sucesso, o jogo mostra uma mensagem de sucesso e mostra em que posição está a letra que o jogador adivinhou
    ...
    E termino o jogo
    Então o jogo mostra que adivinhei uma letra com sucesso
  ...
  Se o jogador errar ao tentar adivinhar a letra, o jogo mostra uma mensagem de erro e mostra quais as partes o boneco da forca perdeu.
    Dado que comecei um jogo
    E que escolhi que a palavra a ser sorteada deverá ter "3" letras
    Quando tento adivinhar que a palavra tem a letra "z"
    E termino o jogo
    Então o jogo mostra que errei a adivinhação da letra
    E o jogo termina com a seguinte mensagem na tela:
    """
