...
describe Game do
  ...
  describe "#raffle" do
    ...
    it "makes a transition from :initial to :word_raffled on sucess" do
  ...
  describe "#guess_letter" do
    it "returns true if the raffled words contains the given letter" do
    ...
    it "returns false if the gven letter is an blank string" do
      game.raffled_word = "hey"
